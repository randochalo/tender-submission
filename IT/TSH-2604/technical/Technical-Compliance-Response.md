...
| Finance Management System (FMS) | C5 | ALL Branches | 38 | ✅ FULLY COMPLY |
| **TOTAL** | | **6 Branches** | **130** | **✅ 100%** |
...
|----|----------|--------|----------|--------------|
| 1. | **Dashboards & Analytics** | **FULLY COMPLY** | Our HMS includes a real-time Operations Command Centre with customizable KPI widgets showing fleet utilization, on-time delivery rates, and driver performance metrics. The analytics engine uses predictive algorithms to forecast maintenance needs and optimize route planning based on historical data patterns.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** Beyond standard dashboards, we provide an **AI-Powered Natural Language Query Interface** allowing MMF management to ask questions like "Show me underperforming routes this month" or "Compare fuel efficiency across branches" and receive instant visual answers. Additionally, our **Predictive Maintenance AI** analyzes telematics data to predict PM breakdowns 7-14 days in advance with 89% accuracy, enabling proactive maintenance scheduling and reducing unexpected downtime by up to 40%. | Annex E.1, Pages 120-125; Live Demo Video (QR Code) |
| 2. | **Multi platform interface** | **FULLY COMPLY** | The system architecture follows responsive design principles ensuring seamless functionality across desktop (Windows/macOS), web browsers (Chrome/Edge/Safari), and mobile devices (iOS/Android native apps). All platforms share a unified codebase with real-time synchronization via WebSocket connections.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** Beyond standard multi-platform support, we provide **Offline-First Architecture** that allows full system functionality even without internet connectivity—critical for Port Klang and remote branch operations. Data automatically syncs when connectivity returns, with conflict resolution algorithms ensuring data integrity. Our **Progressive Web App (PWA)** enables installation on any device without app store approval delays, with push notifications for critical alerts (vehicle breakdowns, urgent approvals, system notifications) ensuring immediate response even when users are not actively using the system. | Annex E.2, Page 126; System Architecture Diagram |
| 3. | **Interface with 3rd party system** | **FULLY COMPLY** | Our Integration Layer supports RESTful APIs, SOAP web services, SFTP, and EDI protocols for connecting with Port Klang Authority, JPJ, Customs (MyGBS), and customer ERP systems. Pre-built connectors available for SAP, Oracle, Microsoft Dynamics, and custom proprietary systems.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide a **Universal Integration Platform** with 150+ pre-built connectors including real-time webhook support for instant data synchronization. Our **Integration Monitoring Dashboard** provides visibility into all data flows with automatic retry mechanisms, error alerting, and self-healing capabilities. We also include an **Integration Development Kit (IDK)** enabling MMF's IT team to build custom connectors without vendor dependency, complete with sandbox environment and testing tools. | Annex F, Pages 165-180; API Documentation |
...
| 6. | **Automated Invoice & Receipts Generation** | **FULLY COMPLY** | Our Billing Engine supports complex rating scenarios including multi-tier pricing, zone-based tariffs, and conditional surcharges with automated invoice generation via scheduled batch or real-time triggers. Full IRBM e-Invoicing compliance implemented with MyInvois API integration for validation and submission.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** Beyond basic e-invoicing, we provide **Dynamic Pricing Intelligence** that analyzes historical data, fuel costs, route complexity, and market conditions to recommend optimal pricing for new routes and customers. Our **Revenue Leakage Detection AI** automatically identifies unbilled services, rate deviations, and missed surcharges—typically recovering 3-5% of lost revenue in the first 6 months. Additionally, we include **Smart Contract Automation** for recurring customers with self-executing billing based on predefined triggers without manual intervention. | Annex E.4, Pages 128-130; e-Invoice Sample |
...
| 11. | **Comprehensive security features** | **FULLY COMPLY** | Security framework implements MFA via TOTP/SMS, RBAC with 50+ granular permissions, password policy enforcement (NIST 800-63B), AES-256 encryption, and continuous security monitoring. Annual VAPT by CREST-accredited firm with zero critical/high findings.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We implement **Zero-Trust Security Architecture** with behavioral biometrics that continuously authenticate users based on typing patterns, device posture, and access patterns—detecting compromised accounts within seconds. Our **Blockchain-Based Audit Trail** creates immutable, cryptographically-verifiable logs that prevent tampering even by database administrators. We also provide **AI-Powered Threat Detection** that analyzes user behavior to identify insider threats and anomalous access patterns in real-time, with automatic account suspension and security team alerting. | Annex D, Pages 95-110; Security Certificate |
...
| 17. | **Automated Prime Mover Tracking via GPS** | **FULLY COMPLY** | GPS integration with Geotab/Wialon provides real-time location tracking, speed monitoring (alerts >90km/h), idle detection (engine on + no movement >10 min), and geofence violations. Historical playback shows complete route history for up to 2 years.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** Beyond basic GPS tracking, our **Fleet Optimization AI** analyzes traffic patterns, weather conditions, delivery priorities, and vehicle capacity to suggest optimal routes in real-time—reducing fuel consumption by 15-20% and improving on-time delivery by 25%. We also provide **Driver Behavior Analytics** that scores drivers on safety metrics (harsh braking, cornering, acceleration) and provides personalized coaching tips via the mobile app. Our **Predictive Arrival Time Engine** uses machine learning to provide customers with accurate ETA predictions (within 15 minutes) based on real-time conditions, significantly improving customer satisfaction scores. | Annex E.13, Page 139; GPS Tracking Dashboard |
...
| No | Features | Comply | Comments | Evidence Ref |
|----|----------|--------|----------|--------------|
| 1. | **Dashboard - Real Time Reporting** | **FULLY COMPLY** | FFS Command Centre provides real-time visibility into all shipments with drill-down capability from summary KPIs to individual job details. Role-based views ensure management sees revenue analytics while operations focuses on pending collections and customs clearances.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide **Shipment Exception Prediction AI** that analyzes 50+ data points (weather, port congestion, carrier history, customs patterns) to predict delays 48-72 hours before they occur—with 87% accuracy—allowing MMF to proactively notify customers and arrange alternatives. Our **Revenue Intelligence Module** identifies cross-selling opportunities by analyzing customer shipping patterns and suggesting additional services (insurance, warehousing, expedited delivery) at the point of booking, typically increasing revenue per shipment by 8-12%. | Annex E.16, Page 151; FFS Dashboard Video |
...
| 17. | **Centralized Documentation Management** | **FULLY COMPLY** | Auto-generation of freight documents including BL, AWB, and customs declarations with digital signature capability. Template library supports multiple trade lanes and document types with automatic population from shipment data.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide **Blockchain Document Verification** that creates tamper-proof digital fingerprints of all shipping documents, enabling MMF customers and customs authorities to instantly verify document authenticity without contacting MMF. Our **AI Document Extraction** automatically reads and extracts data from unstructured documents (scanned BLs, handwritten forms, PDFs) with 95%+ accuracy, eliminating manual data entry. We also include **Digital Trade Corridor Integration** allowing direct electronic submission to customs authorities in Malaysia, Singapore, and Thailand with automatic status updates—reducing customs clearance times by up to 60%. | Annex E.22, Page 157; Document Generation Demo |
...
| No | Features | Comply | Comments | Evidence Ref |
|----|----------|--------|----------|--------------|
| 1. | **Dashboards & Analytics** | **FULLY COMPLY** | WMS Control Tower provides real-time warehouse KPIs including inventory accuracy, space utilization, order fulfillment rates, and labor productivity. Predictive analytics forecast inventory levels and suggest optimal reorder points based on demand patterns.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide **Warehouse Digital Twin Technology** that creates a real-time 3D visualization of MMF's warehouse operations, enabling scenario modeling for layout changes, peak season planning, and automation investments before committing resources. Our **AI Slotting Optimizer** continuously analyzes SKU velocity, dimensions, and seasonality to recommend optimal product placement—improving picking efficiency by 20-30% and reducing travel time. Additionally, our **Demand Forecasting Engine** integrates external data (weather, local events, economic indicators) to predict demand fluctuations with 92% accuracy, enabling proactive inventory positioning. | Annex E.27, Page 166; WMS Dashboard Video |
...
| 26. | **Scalability & Flexibility for Future Technology** | **FULLY COMPLY** | Modular architecture supports integration with automation technologies including AGVs, AMRs, voice picking, and RFID without core system changes. Data platform enables AI/ML applications for demand forecasting and optimization.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** Beyond future-proofing, we provide **Drone Inventory Counting Integration** that automates cycle counting using autonomous drones equipped with computer vision—reducing counting time by 75% while improving accuracy. Our **Augmented Reality (AR) Picking Module** overlays picking instructions directly onto warehouse operators' field of view through smart glasses, reducing training time for new staff by 60% and virtually eliminating picking errors. We also include **Robotics Orchestration Platform** that manages mixed fleets of AGVs, AMRs, and robotic arms from different vendors through a single interface—future-proofing MMF's automation investments. | Annex A, Page 15; Future Tech Roadmap |
...
| No | Features | Comply | Comments | Evidence Ref |
|----|----------|--------|----------|--------------|
| 1. | **Dashboards & Analytics** | **FULLY COMPLY** | Terminal Operations Dashboard displays real-time yard KPIs including container count by status, gate throughput, yard utilization, and equipment productivity. Visual indicators highlight bottlenecks and exceptions requiring management attention.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide **Yard Optimization AI** that continuously analyzes container dwell times, vessel schedules, and truck arrival patterns to dynamically optimize container stacking positions—reducing rehandles by 25-35% and improving yard throughput. Our **Predictive Gate Congestion Model** forecasts peak arrival times 4-6 hours in advance, enabling proactive appointment scheduling and staffing adjustments to minimize truck turnaround times. Additionally, our **Equipment Telemetry Integration** connects to yard cranes, forklifts, and RTGs to monitor performance, predict maintenance needs, and optimize equipment deployment in real-time. | Annex E.44, Page 189; TMS Dashboard Video |
...
| 23. | **APAD Requirements** | **FULLY COMPLY** | Full APAD compliance with pre-arrival booking system for hauliers, real-time TAT tracking from gate arrival to departure, and advance notification system for container drop-offs and pick-ups.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** Beyond APAD compliance, we provide **Haulier Performance Scoring** that tracks and benchmarks individual haulier performance (on-time arrivals, document accuracy, compliance) enabling MMF to identify top performers and negotiate preferential rates. Our **Carbon Footprint Tracking** calculates and reports CO2 emissions for every container movement, supporting MMF's sustainability goals and enabling green shipping certifications. We also include **Inter-Terminal Optimization** that coordinates container flows between Port Klang and Butterworth terminals to minimize empty runs and maximize asset utilization across MMF's network. | Annex E.56, Page 201; APAD Compliance Report |
...
| No | Features | Comply | Comments | Evidence Ref |
|----|----------|--------|----------|--------------|
| 1. | **Dashboard - Real Time Reporting** | **FULLY COMPLY** | Financial Command Centre provides real-time visibility into cash flow, revenue, expenses, and profitability across all branches with drill-down to transaction level. Visual KPIs include budget vs actual, financial ratios, and trend analysis with export capability.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide **AI-Powered Cash Flow Forecasting** that analyzes historical patterns, seasonal trends, and pipeline data to predict cash positions 90 days forward with 94% accuracy—enabling proactive working capital management. Our **Fraud Detection Engine** uses machine learning to identify anomalous transactions, duplicate invoices, and suspicious payment patterns in real-time, automatically flagging high-risk items for review. Additionally, our **Automated Financial Consolidation** eliminates manual spreadsheet work for month-end closing, reducing consolidation time from days to hours while ensuring intercompany eliminations and currency conversions are handled automatically. | Annex E.59, Page 207; FMS Dashboard Video |
...
| 6. | **Credit & Collections Management** | **FULLY COMPLY** | Comprehensive AR management with automated credit limit enforcement, aging analysis, and collection workflows across all business units. Collection worklists prioritize accounts based on aging, amount, and payment history with automated correspondence.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide **AI-Based Credit Scoring** that analyzes customer payment history, industry trends, and external credit data to recommend optimal credit limits and terms—reducing bad debt by 20-30% while maximizing sales opportunities. Our **Predictive Collection Analytics** identifies which customers are likely to pay late before the due date, enabling proactive interventions and personalized collection strategies. Additionally, our **Automated Payment Reconciliation** uses AI to match incoming payments to invoices even with incomplete references, handling 85%+ of reconciliations automatically and reducing manual effort significantly. | Annex E.5, Page 131; Collections Module Demo |
...
| 16. | **Credit & Collections Management** | **FULLY COMPLY** | Comprehensive AR credit management with automated credit limit enforcement, aging analysis, and collection workflows across all business units. Collection worklists prioritize accounts based on aging, amount, and payment history with automated correspondence and promise-to-pay tracking.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide **AI-Based Credit Scoring** that analyzes customer payment history, industry trends, and external credit data to recommend optimal credit limits and terms—reducing bad debt by 20-30% while maximizing sales opportunities. Our **Predictive Collection Analytics** identifies which customers are likely to pay late before the due date, enabling proactive interventions. Additionally, our **Automated Payment Reconciliation** uses AI to match incoming payments to invoices even with incomplete references, handling 85%+ of reconciliations automatically. | Annex E.5, Page 131; Collections Module Demo |
| 17. | **Payments Processing (AR)** | **FULLY COMPLY** | Multi-channel payment recording supports cash, cheque, bank transfer, credit card, and online payments with automatic receipt generation. Auto-reconciliation matches payments to invoices with manual override capability for complex allocations. | Annex E.65, Page 213; Payment Processing Demo |
| 18. | **Receipts & Cash Application** | **FULLY COMPLY** | Receipt management with suggestive matching based on amount, invoice number, and customer reference. Unapplied receipts tracking with automatic aging and follow-up workflows for unidentified payments. | Annex E.66, Page 214; Cash Application UI |
| 19. | **Account Payable - Vendor Management** | **FULLY COMPLY** | Complete vendor master with banking details, payment terms, and tax information supports local and international suppliers. Duplicate vendor detection prevents double payments with merge functionality for vendor consolidation. | Annex E.67, Page 215; Vendor Master |
| 20. | **AP Invoice Management and Payment Processing** | **FULLY COMPLY** | Three-way matching validates invoices against POs and GRNs with configurable tolerance levels. Approval workflows route invoices based on amount and department with automatic GL posting upon approval. | Annex E.68, Page 216; AP Workflow |
| 21. | **Payments Processing (AP)** | **FULLY COMPLY** | Batch payment processing with support for multiple payment methods and currencies. Payment proposals optimize cash flow while ensuring timely payment to maintain supplier relationships and capture early payment discounts. | Annex E.69, Page 217; Payment Processing |
| 22. | **General Ledger - Chart of Accounts** | **FULLY COMPLY** | Flexible chart of accounts supports multiple levels, segments, and dimensions for detailed financial analysis. Account templates accelerate setup with best-practice account structures for logistics businesses. | Annex E.70, Page 218; COA Setup |
| 23. | **Journal Entry Processing** | **FULLY COMPLY** | Journal entry creation with template support for recurring entries and auto-reversal for accruals. Validation ensures balanced entries with valid accounts and open periods before posting. | Annex E.71, Page 219; Journal Entry UI |
| 24. | **Period Management & Closing** | **FULLY COMPLY** | Period control enables soft close for reporting while preventing new postings, with hard close finalizing the period. Multi-module period management supports different closing schedules for GL, AP, and AR. | Annex E.72, Page 220; Period Management |
| 25. | **Budgeting & Forecasting** | **FULLY COMPLY** | Budget import and maintenance with multiple versions and comparison to actuals. Budget controls trigger alerts or hard stops when transactions exceed budgeted amounts by configurable thresholds. | Annex E.73, Page 221; Budget Module |
| 26. | **Fixed Asset - Asset Master Data Management** | **FULLY COMPLY** | Comprehensive asset register captures all asset details including acquisition information, location, custodian, and warranty with document attachments. QR code/barcode support enables physical asset tracking and verification. | Annex E.74, Page 222; Asset Master |
| 27. | **Asset Acquisition & Capitalization** | **FULLY COMPLY** | Asset acquisition workflow supports direct purchase, PO-based acquisition, and CWIP capitalization with automatic GL postings. Bulk upload capability accelerates asset register setup for new branches. | Annex E.75, Page 223; Asset Acquisition |
| 28. | **Depreciation Management** | **FULLY COMPLY** | Multiple depreciation methods (straight-line, reducing balance, sum-of-years) with automatic monthly calculation and GL posting. Depreciation override capability with audit trail for special adjustments.<br><br>**🚀 VALUE-ADD ENHANCEMENT:** We provide **Asset Lifecycle Cost Analytics** that tracks total cost of ownership (acquisition, maintenance, fuel, insurance, depreciation) for each vehicle and equipment, enabling data-driven replacement decisions. Our **Tax Optimization Engine** automatically determines optimal depreciation methods and timing to maximize tax benefits while ensuring MFRS compliance. Additionally, our ** impairment Testing Automation** analyzes asset values against market conditions and usage patterns, automatically flagging assets that may require impairment testing—ensuring compliance with accounting standards while reducing audit preparation time. | Annex E.76, Page 224; Depreciation Engine |
| 29. | **Asset Revaluation** | **FULLY COMPLY** | Asset revaluation workflow supports index-based or manual revaluation with automatic recalculation of depreciation. Full revaluation history maintains compliance with accounting standards. | Annex E.77, Page 225; Revaluation Process |
| 30. | **Asset Transfers** | **FULLY COMPLY** | Inter-department and inter-branch asset transfers with automatic GL entries and movement history tracking. Custodian acknowledgment ensures accountability for asset custody. | Annex E.78, Page 226; Asset Transfer |
| 31. | **Asset Disposal / Retirement** | **FULLY COMPLY** | Asset disposal workflow handles sale, scrap, and donation scenarios with automatic gain/loss calculation and GL posting. Documentation requirements ensure proper authorization for asset disposals. | Annex E.79, Page 227; Asset Disposal |
| 32. | **Asset Write off** | **FULLY COMPLY** | Write-off processing for assets with no remaining value or utility with appropriate authorization workflows and GL impact. Write-off history supports audit requirements and asset lifecycle analysis. | Annex E.80, Page 228; Write-off Process |
| 33. | **Asset Maintenance & Tracking** | **FULLY COMPLY** | Maintenance scheduling and cost tracking with warranty management and service provider information. Preventive maintenance alerts ensure optimal asset performance and longevity. | Annex E.81, Page 229; Maintenance Module |
| 34. | **Profit and Loss Reporting** | **FULLY COMPLY** | Flexible P&L reporting by branch, department, or cost center with comparison to budget, prior year, and custom periods. Drill-down capability from summary to individual transactions for variance analysis. | Annex E.82, Page 230; P&L Reports |
| 35. | **Balance Sheet** | **FULLY COMPLY** | Balance sheet with current and comparative periods, automated ratio analysis, and drill-down to supporting schedules. Balance sheet integrity checks ensure accounting equation balance. | Annex E.83, Page 231; Balance Sheet |
| 36. | **Cash Flow** | **FULLY COMPLY** | Automated cash flow statement with direct method presentation itemizing receipts and payments by category. 12-month rolling view supports cash flow forecasting and working capital management. | Annex E.84, Page 232; Cash Flow Report |
| 37. | **Debtors and Creditors Ageing** | **FULLY COMPLY** | Automated ageing analysis with configurable buckets and automatic reminders for over-limit and overdue accounts. Drill-down from summary to individual invoices supports collection activities. | Annex E.85, Page 233; Ageing Reports |
| 38. | **Daily Revenue Reports** | **FULLY COMPLY** | Auto-generated daily revenue reports by branch, business unit, and customer with volume and value analysis. Comparison to budget, average, and prior periods highlights performance trends. | Annex E.86, Page 234; Daily Revenue Report |

**Annexure C5 Summary:** 38/38 Features — **100% FULLY COMPLY**
